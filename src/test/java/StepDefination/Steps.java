...
public void enter_text_global_and_select() throws InterruptedException {
	Thread.sleep(2000);
    //driver.findElement(By.xpath("//button[@aria-label='Search']/..//lightning-primitive-icon[@variant='bare']")).click();
	Thread.sleep(3000);

    //driver.findElement(By.xpath("//input[@placeholder=\"Search Contacts and more...\"]")).sendKeys("Hello Rutuja");
}
