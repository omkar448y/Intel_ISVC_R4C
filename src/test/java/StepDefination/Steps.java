...
<<<<<<< HEAD
	...
	public void click_on_next_case_validation() throws InterruptedException {
	   WebElement click=driver.findElement(By.xpath("(//li//button[contains(text(),'Save for Later')]/..//button[contains(text(),'Next')])[2]"));
		Thread.sleep(10000);
	   click.click();
...
//-------------ULT Bulk Upload
	...
	//----------enter text global-----------
	@When("Enter text global and select")
	public void enter_text_global_and_select() throws InterruptedException {
//		Thread.sleep(5000);
//	WebElement	element= driver.findElement(By.xpath("//button[normalize-space()='Search...']"));
//
//	// Use JavaScriptExecutor to directly set the value attribute
//    JavascriptExecutor jsExecutor = (JavascriptExecutor) driver;
//    jsExecutor.executeScript("arguments[0].setAttribute('value', 'Rutuja')", element);
////		 Actions actions = new Actions(driver);
////	        actions.moveToElement(element).click().sendKeys("Sarah").build().perform();
////			Thread.sleep(5000);
//	       driver.findElement(By.xpath("//span[@title='Sarah Aggelidis']//span[@part='formatted-rich-text']")).click(); 
//	        
		 // Use WebDriverWait to wait until the input field is visible
