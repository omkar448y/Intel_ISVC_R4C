...
<<<<<<< HEAD
	public void EnterSoldToNumber(String string) 
	{
		EnterSoldto.click();
...
//-----------------Case Edit TC-Submitted Pending Action-------------
	...
	//	EnterTextGlobalfield.sendKeys(Keys.RETURN); // To Click on ENter Button

	}

	@FindBy(xpath="//search_dialog-instant-result-item[3]//div[1]//div[1]//records-highlights-icon[1]//force-record-avatar[1]//span[1]//img[1]")
